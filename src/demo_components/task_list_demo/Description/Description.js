    ...
    return (
        <div className={style.container}>
            <h3>
                ...
                важности, срочности или каких-либо других параметров. Для переименования категории или задачи нужно просто
                дважды кликнуть на её названии кнопкой мышки (или двойной тап на сенсорном экране). Чтобы сменить цвет
                заголовка, также достаточно просто кликнуть на нем.
            </h3>
        </div>
    );
}
